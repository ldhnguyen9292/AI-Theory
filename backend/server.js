...
const CV_DATA = {
  ...
  workExperience: [
      ...
      projects: [
        {
          name: "Teamfight.lol",
          role: "Frontend Developer",
          description: "Collaborated directly with U.S. clients to gather requirements, clarify expectations, and estimate timelines for new features. Developed and maintained a responsive web design, optimized performance and usability across various devices for a Teamfight Tactics analytics platform.",
          technologies: ["Vue.js"]
        },
        {
          name: "Satorie",
          role: "Frontend Developer",
          description: "Initialized project repositories and integrated essential libraries, including email services, for a CFO/strategy consulting platform for SMBs. Collaborated with developers throughout the design and development lifecycle. Optimized applications for SEO and ensured responsive design across devices. Deployed applications to production environments and provided post-release monitoring and support.",
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          technologies: ["Node.js", "Express.js", "PostgreSQL", "TypeORM", "RESTful APIs", "Microservices Architecture", "JWT"]
        },
        {
          name: "My Fitness Studio",
          role: "Backend Developer",
          description: "Updated and maintained API functions to ensure continued performance and reliability for a personal health and fitness application.",
    ...
    },
    {
      ...
      recognition: "Certificate of Merit from the Ho Chi Minh City Department of Health for outstanding contributions to COVID-19 prevention and control (2020)."
    }
  ],
  education: [
    {
  ...
  skills: {
    ...
    databases: ["MySQL", "PostgreSQL", "MongoDB", "DynamoDB", "Redis", "TypeORM", "Mongoose", "Typegoose", "Elasticsearch"],
    ...
    professionalSkills: ["Problem-solving", "Time management", "Teamwork and collaboration", "Attention to detail", "Adaptability", "Self-learning"]
  },
  achievements: [
    {
      ...
      year: "2020",
      description: "For outstanding contributions to COVID-19 prevention and control during duties at Tan Son Nhat International Airport."
    }
  ]
};
